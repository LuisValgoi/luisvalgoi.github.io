; (function ($) {
    ...
    function onLoadRepositories() {
        fetch('https://api.github.com/users/LuisValgoi/repos')
            .then(response => response.json())
            .then(data => {
                var content = `<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design print">
